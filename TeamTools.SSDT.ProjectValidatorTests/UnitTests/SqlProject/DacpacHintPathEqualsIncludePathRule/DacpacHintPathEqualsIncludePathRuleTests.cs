...
namespace TeamTools.SSDT.ProjectValidatorTests
{
    ...
    [TestOfRule(typeof(DacpacHintPathEqualsIncludePathRule))]
    public class DacpacHintPathEqualsIncludePathRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DacpacHintPathEqualsIncludePathRuleTests));
        }
    }
}
