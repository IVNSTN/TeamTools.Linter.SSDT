...
namespace TeamTools.SSDT.ProjectValidatorTests
{
    ...
    [TestOfRule(typeof(DuplicateIncludeRule))]
    public sealed class DuplicateIncludeRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DuplicateIncludeRuleTests));
        }
    }
}
