...
namespace TeamTools.SSDT.ProjectValidatorTests
{
    ...
    [TestOfRule(typeof(SqlProjObsoleteOptionsRule))]
    public sealed class SqlProjObsoleteOptionsRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SqlProjObsoleteOptionsRuleTests));
        }
    }
}
