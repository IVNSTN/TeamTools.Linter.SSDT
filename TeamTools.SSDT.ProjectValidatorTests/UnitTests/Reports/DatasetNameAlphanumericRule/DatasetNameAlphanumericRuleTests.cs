...
namespace TeamTools.SSDT.ProjectValidatorTests
{
    ...
    [TestOfRule(typeof(DatasetNameAlphanumericRule))]
    public sealed class DatasetNameAlphanumericRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DatasetNameAlphanumericRuleTests));
        }
    }
}
