...
namespace TeamTools.SSDT.ProjectValidatorTests
{
    ...
    [TestOfRule(typeof(DatasourceReferenceNameAutoGeneratedRule))]
    public sealed class DatasourceReferenceNameAutoGeneratedRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DatasourceReferenceNameAutoGeneratedRuleTests));
        }
    }
}
