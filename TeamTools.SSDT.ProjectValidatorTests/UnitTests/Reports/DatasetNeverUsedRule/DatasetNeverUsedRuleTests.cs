...
namespace TeamTools.SSDT.ProjectValidatorTests
{
    ...
    [TestOfRule(typeof(DatasetNeverUsedRule))]
    public sealed class DatasetNeverUsedRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DatasetNeverUsedRuleTests));
        }
    }
}
