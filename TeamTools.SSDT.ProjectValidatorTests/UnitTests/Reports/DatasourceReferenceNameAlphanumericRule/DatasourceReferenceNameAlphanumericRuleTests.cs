...
namespace TeamTools.SSDT.ProjectValidatorTests
{
    ...
    [TestOfRule(typeof(DatasourceReferenceNameAlphanumericRule))]
    public sealed class DatasourceReferenceNameAlphanumericRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DatasourceReferenceNameAlphanumericRuleTests));
        }
    }
}
