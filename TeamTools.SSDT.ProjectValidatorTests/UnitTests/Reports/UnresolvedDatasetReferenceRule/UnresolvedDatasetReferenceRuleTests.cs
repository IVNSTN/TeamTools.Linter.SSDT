...
namespace TeamTools.SSDT.ProjectValidatorTests
{
    ...
    [TestOfRule(typeof(UnresolvedDatasetReferenceRule))]
    public sealed class UnresolvedDatasetReferenceRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(UnresolvedDatasetReferenceRuleTests));
        }
    }
}
