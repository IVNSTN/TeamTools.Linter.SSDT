...
namespace TeamTools.SSDT.ProjectValidatorTests
{
    ...
    [TestOfRule(typeof(DatasourceReferenceNameMinLengthRule))]
    public sealed class DatasourceReferenceNameMinLengthRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DatasourceReferenceNameMinLengthRuleTests));
        }
    }
}
