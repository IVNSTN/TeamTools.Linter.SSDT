...
namespace TeamTools.SSDT.ProjectValidatorTests
{
    ...
    [TestOfRule(typeof(ParameterNeverUsedRule))]
    public sealed class ParameterNeverUsedRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ParameterNeverUsedRuleTests));
        }
    }
}
