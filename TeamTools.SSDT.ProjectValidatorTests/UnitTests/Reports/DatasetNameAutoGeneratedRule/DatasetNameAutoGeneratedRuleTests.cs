...
namespace TeamTools.SSDT.ProjectValidatorTests
{
    ...
    [TestOfRule(typeof(DatasetNameAutoGeneratedRule))]
    public sealed class DatasetNameAutoGeneratedRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DatasetNameAutoGeneratedRuleTests));
        }
    }
}
