...
namespace TeamTools.SSDT.ProjectValidatorTests
{
    ...
    [TestOfRule(typeof(DatasourceNeverUserRule))]
    public sealed class DatasourceNeverUserRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DatasourceNeverUserRuleTests));
        }
    }
}
