...
namespace TeamTools.SSDT.ProjectValidatorTests
{
    ...
    [TestOfRule(typeof(IntegratedSecurityInDatasourceRule))]
    public sealed class IntegratedSecurityInDatasourceRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(IntegratedSecurityInDatasourceRuleTests));
        }
    }
}
