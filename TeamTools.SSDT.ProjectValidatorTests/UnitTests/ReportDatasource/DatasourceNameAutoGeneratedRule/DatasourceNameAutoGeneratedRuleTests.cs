...
namespace TeamTools.SSDT.ProjectValidatorTests
{
    ...
    [TestOfRule(typeof(DatasourceNameAutoGeneratedRule))]
    public sealed class DatasourceNameAutoGeneratedRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DatasourceNameAutoGeneratedRuleTests));
        }
    }
}
